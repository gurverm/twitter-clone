...
// context is created opposed to the use of props to allow chldren to have access to the context no matter how far down the 'tree' they are
...
export default function SupabaseProvider({
  ...
  // useEffect is used to handle the side effects in React such as fetching data, and updating DOM
  useEffect(() => {
    const {
      data: { subscription },
